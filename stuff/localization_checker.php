<?php // localization checker - simple php script by kay27, for QazMeet project, (c)2014
...
$res_dir='../qazmeet/files/resource';
...
//check_presence('../qazmeet/Makefile',$localizations);
//check_presence('../qazmeet/Makefile.in',$localizations);
check_presence('../qazmeet/mcu.cxx',$localizations);
check_template_html($res_dir.'/template.html',$localizations);
check_html_cxx('../qazmeet/html.cxx',$localizations);
