 ...
 * telnet.h
 *
 * Copyright (C) 2015 Andrey Burbovskiy, QazMeet, All Rights Reserved
 *
...
const PString TEL_WELCOME = PString(PRODUCT_NAME_TEXT)+"/"+PString(MAJOR_VERSION)+"."+PString(MINOR_VERSION)+"."+PString(BUILD_NUMBER)+" "+"Copyright (c) by QazMeet Team"+"\r\n"
                            +"git revision: "
#ifdef GIT_REVISION
