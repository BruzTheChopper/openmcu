...
<p>\
Служба <b>QazMeet</b> запущена и работаем в следующих режимах.\
</p>\
<p>\
<p><b>SFU (Selective Forwarding Unit)</b> - Видеоконференция на основе простого перенаправления потоков</p>\
<p><b>Simulcast</b> - Видеоконференция на основе параллельной передачи потоков</p>\
<p><b>MCU (Multipoint Control Unit)</b> - Видеоконференция на основе микширования потоков</p>\
\
';
...
window.l_server_id                                 = "Идентификатор сервера QazMeet";
