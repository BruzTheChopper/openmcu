...
#define MCU_PLUGIN_DIR "/opt/qazmeet/lib/ptlib"
...
#define SYS_BIN_DIR "/opt/qazmeet/bin"
// specify the path for .conf files
#define SYS_CONFIG_DIR "/opt/qazmeet/config"
// specify the path for audio&video export via named pipes (linux, freebsd)
#define SYS_PIPE_DIR "/opt/qazmeet/pipe"
// specify the path for built-in web server resources
#define SYS_RESOURCE_DIR "/opt/qazmeet/resource"
// specify server logs folder
#define SERVER_LOGS "/opt/qazmeet/log"
// specify true font directory
#define TRUETYPE_FONT_DIR "/opt/qazmeet/font"
// specify records directory
#define RECORDS_DIR "/opt/qazmeet/records"
// specify certificates directory
#define SYS_SSL_DIR "/opt/qazmeet/ssl"
...
#define CONFIG_PATH PString(SYS_CONFIG_DIR)+PATH_SEPARATOR+"qazmeet.ini"
