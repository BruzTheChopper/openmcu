...
VideoMixConfigurator QazMeet::vmcfg;
...
QazMeet::QazMeet()
  : QazMeetPreInit(), QazMeetProcessAncestor(ProductInfo)
{
#ifndef _WIN32
...
void QazMeet::OnConfigChanged()
{
}

////////////////////////////////////////////////////////////////////////////////////////////////////

BOOL QazMeet::Initialise(const char * initMsg)
{
  PDirectory exeDir = executableFile.GetDirectory();
  exeDir.Change();
  ...
  serverId = cfg.GetString(ServerIdKey, QazMeet::Current().GetName() + " v" + QazMeet::Current().GetVersion());
  ...
  int _scaleFilterType = QazMeet::GetScaleFilterType(_scaleFilterName);
...
void QazMeet::CreateHTTPResource(const PString & name)
{
...
void QazMeet::LogMessage(const PString & str)
{
...
void QazMeet::LogMessageHTML(PString str)
{
...
BOOL QazMeet::MCUHTTPListenerCreate(const PString & ip, unsigned port)
{
...
void QazMeet::MCUHTTPListenerShutdown()
{
...
void QazMeet::MCUHTTPListenerDelete()
{
  MCUHTTPListenerShutdown();
...
BOOL QazMeet::OTFControl(const PString & data, PString & rdata)
{
...
BOOL QazMeet::OTFControl(const PStringToString & data, PString & rdata)
{
...
static pid_t popen2(const char *command, int *infp = NULL, int *outfp = NULL)
{
    ...
    else if (pid == 0)
    {
      ...
      argv[argc]=NULL;
      execv(QazMeet::Current().vr_ffmpegPath, argv);
      perror("execv");
      exit(1);
    }
  ...
  : PThread(1000, AutoDeleteThread)
{
  ...
  PStringStream t; t << roomName << "__" // fileName format: room101__2013-0516-1058270__704x576x10
    ...
    << QazMeet::Current().vr_framewidth << "x"
    << QazMeet::Current().vr_frameheight << "x"
    << QazMeet::Current().vr_framerate;
  fileName = t;
  t = QazMeet::Current().ffmpegCall;
